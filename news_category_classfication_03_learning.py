# -*- coding: utf-8 -*-
"""news_category_classfication_03_learning.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1oL5VgEwsOnl3N0JCF9xGphx0dti2MI40
"""
...
X_train, X_test, Y_train, Y_test = np.load(
    './crawling/news_data_max_23_wordsize_16453.npy',
    allow_pickle=True)
print(X_train.shape, Y_train.shape)
print(X_test.shape, Y_test.shape)

model = Sequential()
model.add(Embedding(16453, 300,input_length=23))
